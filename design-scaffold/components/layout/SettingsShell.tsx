...
export default function SettingsShell() {
  ...
  return (
    <div className="flex" style={{ backgroundColor: "#F5F5F5", minHeight: "calc(100vh - 56px)" }}>
      <SectionSidebar
        heading="Settings"
        activeKey={activeTab}
      ...
      <div className="flex-1 overflow-y-auto" style={{ backgroundColor: "#F5F5F5", padding: 32 }}>
        <div style={{ maxWidth: 640 }} className="space-y-6">
          <Card>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 16 }}>
              <span style={{ color: "#3D38FF", display: "flex" }}>{active.icon}</span>
