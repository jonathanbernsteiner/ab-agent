...
// Inner 240px sidebar used inside Settings: gray background, uppercase heading,
// active item = white card with a 2px brand left border + subtle shadow.
export default function SectionSidebar({
  ...
  return (
    <nav
      className="shrink-0"
      style={{ width: 240, borderRight: "1px solid #E2E8F0", backgroundColor: "#F5F5F5" }}
    >
      <div
        style={{
